...
if (isset($_SESSION['previous_page'])) {
    if ($_SESSION['previous_page'] === 'GestioneRecensioni') {
        ...
        $breadcrumbs = '<a href="AreaPersonale.php" title="Vai alla pagina dell\'area personale" aria-label="Vai alla pagina dell\'area personale">Area personale</a>
                    &gt;&gt; <a href="GestioneRecensioni.php' . $page . '" title="Vai alla pagina di gestione delle recensioni" aria-label="Vai alla pagina di gestione delle recensioni">Gestione recensioni</a>';
